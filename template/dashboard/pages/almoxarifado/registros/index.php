...
<head>
  ...
  <script>
    $(function() {
        $( "#dataVencimentoLote" ).datepicker({ dateFormat: 'yy-mm-dd'}).val();
    });
    </script>
    ...
    <div class="content-wrapper">
      ...
      <div class="card card-success">
        <div class="card-header">
          <h3 class="card-title">Registro de Atividade do Material</h3>
        </div>
        <!-- /.card-header -->
        <!-- form start -->
        <form role="form" name="formCad" action="" enctype="multipart/form-data" method="post">
        <?php
          error_reporting(0);
          ini_set("display_errors", 0);
          ?>
            ...
            <div class="form-group">
              ...
              <div class="input-group mb-3">
                <div class="input-group-prepend">
                  <span class="input-group-text"><a href="http://zxing.appspot.com/scan?ret=http://192.168.1.9/sistemagsgv2/template/dashboard/pages/almoxarifado/BarCode.php?produtoum={CODE}"><i class="fa fa-qrcode" aria-hidden="true"></i></a></span>
                </div>
                <input type="text" class="form-control" name="CodBarra" value="<?php echo ($resultadoum); ?>" placeholder="Digite aqui" required>
              </div>
              <label for="LabelNF">Nota Fiscal Nº</label>
              <input type="char" name="numeroNF" class="form-control" required>
              <label for="LabelLote">Número do Lote</label>
              <input type="char" name="numeroLote" class="form-control" required>
              <div class="form-group">
              <label for="LabelVencimento">Vencimento do Lote</label>
                    <input type="text" class="form-control" name="dataVencimentoLote" id="dataVencimentoLote" placeholder="Data da Leitura">
              </div>
              ...
              <hr>
              <center><label for="LabelStatus">Status do Lote</label></center>
              <select name="statusLote" class="form-control" id="selectStatus">
              ...
              <div class="col-sm-20">
                <!-- textarea -->
                <div class="form-group">
                  <label>Histórico do Registro</label>
                  <textarea class="form-control" rows="3" name="historicoRegistro" placeholder="Adicionar descrição"></textarea>
                  <div class="custom-file">
                    <input type="file" class="custom-file-input" name="arquivo" id="arquivo" multiple="multiple">
                    <label class="custom-file-label" for="exampleInputFile">Insira a imagem <a title="Certifique-se de que os arquivos estarão no formato de imagem"></a></label>
                  </div>
                </div>
              </div>
              <hr>
              <hr>
              <label for="LabelUsuario">Usuário</label>
              <div class="input-group mb-3">
                <div class="input-group-prepend">
                  <span class="input-group-text">@</span>
                </div>
                <input type="text" class="form-control" name="id_user" value="<?php echo ($nick) ?>">
              </div>
            </div>
            <div class="card-footer">
              <center><button type="submit" name="btnRegistroAtividade" onClick="process()" class="btn btn-success toastsDefaultSuccess">Processar Registro</button></center>
            </div>
          </div>
        </form>
      </div>
