        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Envio dos XML's</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
...
<!-- /.content-header -->
  ...
  <div class="card card-success">
    <div class="card-header">
      <h3 class="card-title">Pasta de Origem</h3>
    </div>
    <form role="form" method="POST" action="pdfDanfe.php" enctype="multipart/form-data">
        <div class="card-body">
          <div class="form-group">
            <label for="exampleInputFile">C:/ArquivosSAP/xml/</label>
        ...
        <div class="card-footer">
          <button type="submit" class="btn btn-success">Carregar PDF's</button>
        </div>
      </form>    <!-- /.card-body -->
  </div>
  <!-- /.card -->
